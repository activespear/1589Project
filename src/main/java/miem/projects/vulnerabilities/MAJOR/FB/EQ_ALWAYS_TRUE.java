...
public class EQ_ALWAYS_TRUE {

    // Небезопасная конструкция: equals всегда возвращает true
    ...
    public static void unsafeEqualsTest() {
        ...
        System.out.println("Unsafe equals result: " + a.equals(b));  // всегда true
    }
    ...
    public static void safeEqualsTest() {
        ...
        System.out.println("Safe equals result: " + a.equals(b));  // true если id совпадают
    }
